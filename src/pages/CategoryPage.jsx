			...
			{activeQuiz ? (
				...
				<>
					<div className='flex flex-col gap-5'>
						<h1 className='font-serif text-4xl text-white text-center font-bold'>
							{category}
						</h1>
					...
					<button
						className='text-white text-xl bg-gradient-to-r from-green-500 to-blue-600 hover:from-pink-600 hover:to-yellow-600 py-2 rounded-lg font-bold px-5 transition-all'
